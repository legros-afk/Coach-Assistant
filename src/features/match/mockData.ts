...
export const DEMO_SQUAD: Player[] = [
  ...
  { id: 'p02', name: 'Dominic',   defaultGroup: 'back',      eligibleGroups: ['back'] },
  ...
  { id: 'p05', name: 'Elliott',   defaultGroup: 'forward',   eligibleGroups: ['forward', 'back'] },
  { id: 'p06', name: 'Ethan',     defaultGroup: 'forward',   eligibleGroups: ['forward', 'back'] },
  ...
  { id: 'p15', name: 'Robin',     defaultGroup: 'back',      eligibleGroups: ['back'] },
  ...
  { id: 'p20', name: 'Arlo',      defaultGroup: 'forward',   eligibleGroups: ['forward'] },
  { id: 'p21', name: 'Connor B',  defaultGroup: 'back',      eligibleGroups: ['back'] },
  { id: 'p22', name: 'Hayden',    defaultGroup: 'back',      eligibleGroups: ['back', 'scrumhalf'] },
  ...
  { id: 'p35', name: 'Hector',    defaultGroup: 'forward',   eligibleGroups: ['forward', 'scrumhalf'] },
